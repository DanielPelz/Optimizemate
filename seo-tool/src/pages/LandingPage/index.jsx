...
const LandingPage = () => {
  return (
    <main className="flex-grow">
      <section className="hero-section bg-blue-600 py-20 dark:bg-gray-800 text-center h-96">
        <div className="container mx-auto px-4 text-white">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">
            Steigere deine Website mit Optimizemate 
          </h1> 
          <p className="text-xl mb-8">
            Entdecke unser leistungsstarkes SEO - Tool, um dein Online - Ranking
            zu verbessern. 
          </p> 
      ...
      <section className="features-section py-20 bg-gray-100 dark:bg-gray-800">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            <div className="bg-gray-100 p-6 rounded-lg">
              ...
              <p className="text-gray-600">
                {" "}
                Geschäftsführer, Mustermann GmbH{" "}
              </p>{" "}
            </div>{" "}
            <div className="bg-gray-100 p-6 rounded-lg">
              <p className="italic mb-4">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              ...
              <ul className="mb-6">
                <li> 5 Projekte </li> <li> 50 Keywords </li>{" "}
                <li> 10.000 Seiten - Crawl </li> <li> Email - Support </li>{" "}
              </ul>{" "}
            ...
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              ...
              <p className="text-4xl mb-6">
                {" "}
                €79{" "}
                <span span className="text-gray-600 text-xl">
                  {" "}
                  /Monat
                </span>
              </p>{" "}
              <ul className="mb-6">
                <li> 25 Projekte </li> <li> 250 Keywords </li>{" "}
                <li> 50.000 Seiten - Crawl </li> <li> Live - Chat Support </li>{" "}
              </ul>{" "}
              <button className="bg-blue-600 text-white font-bold py-2 px-6 rounded-lg hover:bg-blue-500 transition-colors">
                Jetzt wählen{" "}
              </button>{" "}
            ...
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              ...
              <ul className="mb-6">
                <li> Unbegrenzte Projekte </li> <li> Unbegrenzte Keywords </li>{" "}
